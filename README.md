...
Have fun!
# Limitations
 - It currently uses google input recognition api which means it requires internet access
 - It has hardcoded /dev/input paths so it won't work on any other device
PR are welcomed!
Have fun!
